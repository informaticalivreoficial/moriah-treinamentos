                            ...
                            <div class="tab-pane fade" id="custom-tabs-four-responsavel" role="tabpanel" aria-labelledby="custom-tabs-four-responsavel-tab">
                                <div class="row mb-2 text-muted">
                                    ...
                                    <div class="col-12 col-md-6 col-lg-4"> 
                                        <div class="form-group">
                                            <label class="labelforms text-muted"><b>Nome:</b></label>
                                            <input type="text" class="form-control text-muted" placeholder="Nome" name="responsavel_nome" value="{{old('responsavel_nome')}}">
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-6 col-lg-3"> 
                                        <div class="form-group">
                                            <label class="labelforms text-muted"><b>CPF:</b></label>
                                            <input type="text" class="form-control text-muted cpfmask" placeholder="CPF" name="responsavel_cpf" value="{{old('responsavel_cpf')}}">
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-6 col-lg-3"> 
                                        <div class="form-group">
                                            <label class="labelforms text-muted"><b>RG:</b></label>
                                            <input type="text" class="form-control text-muted rgmask" placeholder="RG" name="responsavel_rg" value="{{old('responsavel_rg')}}">
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-6 col-lg-2"> 
                                        <div class="form-group">
                                            <label class="labelforms text-muted"><b>Telefone:</b></label>
                                            <input type="text" class="form-control text-muted celularmask" placeholder="Telefone" name="responsavel_telefone" value="{{old('responsavel_telefone')}}">
                                        </div>
                                    </div>                                                                               
                                </div>
                            </div>
